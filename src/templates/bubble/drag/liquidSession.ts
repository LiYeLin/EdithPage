...
export class LiquidSession {
  ...
  private readonly onSettling: (settling: boolean) => void

  constructor(onPending: (arrival: Arrival | null) => void, onRelease: (reason: ReleaseReason) => void, timer: Clock = clock, onSettling: (settling: boolean) => void = () => {}) {
