...
export function SiteTile({
  ...
  return (
    <div ref={setNodeRef} className={`site-tile-wrap ${wrapClassName} ${isDragging ? 'is-drag-source' : ''}`} style={jiggleStyle} data-onboarding-edit data-site-id={site.id} data-module-id={moduleId} data-variant={variant} data-pending-arrival={pending || undefined} aria-hidden={pending || undefined}
